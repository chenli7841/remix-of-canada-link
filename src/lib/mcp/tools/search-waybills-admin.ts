...
export default defineTool({
  ...
  description:
    "Search EPLUS waybills by tracking number, customer, shop order or forwarding request using the signed-in account's normal staff permission. Read-only and CAD-only. When results exceed 5, summarize and ask the user to narrow the search.",
  inputSchema: {

...
export default defineTool({
  ...
  description:
    "List the signed-in user's EPLUS shop orders with optional order-number, status and date filters. Returns a small page newest first; ask before loading more. All totals are CAD.",
  inputSchema: {
    order_no: z.string().max(100).optional(),

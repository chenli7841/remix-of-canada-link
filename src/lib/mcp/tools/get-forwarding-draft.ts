...
export default defineTool({
  ...
  description:
    "Retrieve the signed-in customer's draft. Present every item, route, address, and CAD value before asking for confirmation.",
  ...
  handler: async ({ draft_id }, ctx) => {
    ...
    return {
      ...
      structuredContent: { currency: "CAD", draft: data },
    };
  },
});

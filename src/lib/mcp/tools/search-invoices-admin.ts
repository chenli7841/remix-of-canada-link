...
export default defineTool({
  ...
  description:
    "Search EPLUS invoices using the signed-in account's normal staff permission. Read-only; all money is CAD. This tool cannot pay, refund, deduct funds, or change payment status.",
  inputSchema: {

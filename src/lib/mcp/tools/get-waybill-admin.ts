...
export default defineTool({
  name: "get_waybill_admin",
  title: "Get waybill with admin permissions",
  description:
    "Mapping of the existing EPLUS admin waybill detail view. Uses the signed-in account's normal staff permission.",
  inputSchema: { waybill_no: z.string().min(1).max(100) },

...
export default defineTool({
  name: "search_eplus_knowledge",
  title: "Search EPLUS business knowledge",
  description:
    "Search curated EPLUS policies and service procedures before answering a general business question. It contains no live customer data, prices, permissions, balances, orders or tracking; use the relevant EPLUS tool for those.",

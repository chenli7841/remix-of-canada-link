...
export default defineTool({
  ...
  description:
    "Search EPLUS forwarding orders across statuses using the signed-in account's normal staff permission. Read-only; all customer-facing money is CAD. When results exceed 5, summarize and ask the user to narrow the search instead of displaying all records.",
  inputSchema: {
